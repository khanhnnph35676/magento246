...
namespace Tigren\ShippingRestriction\Ui\Component\Listing\Column;
...
{
    const URL_PATH_EDIT = 'shipping_restriction/index/form';
    const URL_PATH_DELETE = 'shipping_restriction/index/delete';
