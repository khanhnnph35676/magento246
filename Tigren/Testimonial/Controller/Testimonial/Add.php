...
class Add extends Action
{
    ...
    public function execute()
    {
        ...
        if ($request->isPost()) {
            ...
            if (isset($_FILES['profile_image']) && $_FILES['profile_image']['size'] > 0) {
                try {
                    ...
                    $result = $uploader->save($this->mediaDirectory . '/testimonials/profile_image/');
        ...
        return $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('testimonial/testimonial/index');
    }
}
